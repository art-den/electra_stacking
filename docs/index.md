...
в форуме [astronomy.ru](https://astronomy.ru/forum/index.php/topic,201076.0.html)
...
Добавление файлов в проект выполняется при помощи 
* меню **Обработка -> Добавить файлы ...**,
* или перетягивания папки с файлами или самих файлов на окно программы из проводника.
...
На что обращать внимание при отключении снимков? Для хорошего результата при сложении НЕ должны 
использоваться снимки с
1. раздутыми звёздами
2. смазанными звёздами
3. облаками
4. дымкой
5. посторонними объектами (крышами домов, деревьями, заборами, фонарными столбами)
...
изображений. Также к нему линейно будет приводится фон и гистограмма всех изображений.
